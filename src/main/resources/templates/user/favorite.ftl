...
<section class="user_page">
    <div class="page_caption">
        <div class="container">
            <h1>In tis page you can see your favorite items</h1>
    ...
    <div class="container">
        <div class="tabs">
            <ul class="tab-links">
                <li class="active"><a href="user_favorite.html"><span>My Favorite items</span><i class="fa fa-star-o"></i></a></li>
                        ...
                        <li>
                            <div class="fav_set">
                                ...
                                <div class="remove_fav">
                                    <a href="#confirmation" class="popupBtn">Remove</a> / <a href="edit_cars.html">Edit</a>
                                </div>
                            </div>
                            <a href="#">
                                <div class="immagine">
...
<!-- Start Confirmation Pop up -->

<div id="confirmation" class="confirm mfp-with-anim mfp-hide">
    <div class="popupTitle">
        <h2>Delete Car</h2>
    </div>
    <div class="popupBody">
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ea sit aperiam nisi nobis repellendus reiciendis quisquam rerum, delectus assumenda nulla possimus molestiae tenetur quos laboriosam, asperiores placeat iusto consequatur voluptas.</p>
    </div>
    <div class="popupMeta clearAfter">
        <button class="btn left btn-orange">Delete</button>
        <button class="btn right popup-close">Cancel</button>
    </div>
</div>
